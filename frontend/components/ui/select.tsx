...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position="popper"
      className={cn(
        "z-[9999] max-h-[300px] min-w-[220px] overflow-y-auto overflow-x-hidden rounded-md border bg-white text-black shadow-2xl",
