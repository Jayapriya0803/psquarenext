  ...
  return (
    <main className="bg-slate-50">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-14 text-white text-center">
          <h1 className="text-4xl md:text-5xl font-bold">
            Contact & Enquiry
          </h1>

          <p className="mt-6 text-lg text-blue-100 max-w-3xl mx-auto">
            Need industrial safety equipment? Share your requirements and our
            team will respond with the best quotation.
          </p>
        </div>
      </header>

      {/* CONTENT */}
      <section className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 -mt-24 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="mt-1 w-full border border-gray-300 rounded-lg p-3 h-32 focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#0E5AA7] text-white py-3 rounded-lg font-semibold hover:bg-[#0B3C6F]"
            >
              Submit Enquiry
            </button>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
            <iframe
              ...
              style={{ border: 0 }}
              title="P Square Enterprises Location Map"
            />
          </div>

          {/* OFFICE DETAILS */}
          <address className="bg-white shadow-xl rounded-2xl p-8 not-italic">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>
                <strong>Phone:</strong>
                <br />
                <a href="tel:+919840912665" className="text-blue-700">
                  +91 9840912665
                </a>
              </p>
              ...
              <p>
                <strong>Email:</strong>
                <br />
                <a href="mailto:write2psquare@gmail.com" className="text-blue-700">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="bg-white rounded-xl shadow-xl p-8 max-w-sm text-center">
            ...
            <button
              ...
              className="mt-5 bg-[#0E5AA7] text-white px-6 py-2 rounded-lg hover:bg-[#0B3C6F]"
            >
              OK
            </button>
          </div>
